...
class AdminNotesUploadView extends StatefulWidget {
  const AdminNotesUploadView({super.key});

  @override
  State<AdminNotesUploadView> createState() => _AdminNotesUploadViewState();
}

class _AdminNotesUploadViewState extends State<AdminNotesUploadView> {
  ...
  Future<String> uploadTimetable(String fileName, File file) async {
    final ref =
        FirebaseStorage.instance.ref("notes").child("pdfs/$fileName.pdf");
